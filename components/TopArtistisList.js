                  ...
                  >
                    ...
                    <div className="hover:px-1 relative p-0.5 flex flex-col h-full items-start justify-between w-56 duration-200">
                      <div className="m-0.5">
                        ...
                        <p className="line-clamp-2 inline  md:line-clamp-2 text-base w-52 tracking-tight font-bold text-gray-300 ">
                      ...
                      <div className="flex flex-row flex-wrap w-60">
                        ...
                        <p className="md:font-sans font-bold text-xs md:rounded-lg rounded-md md:p-1.5 p-0.5 m-0.5 bg-black bg-opacity-90 hover:bg-green-800">
                          Followers
                          <span className="text-green-400 mx-1">
