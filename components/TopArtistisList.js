                    ...
                    <div className='hover:px-1 ml-3 relative p-0.5 flex flex-col h-full items-start justify-between w-56 duration-200'>
                      <div className=''>
                        <span className='justify-start items-center text-2xl font-bold text-gray-200'>
                          <svg className='w-6 pb-1 h-6 inline' fill='currentColor' viewBox='0 0 20 20' xmlns='http://www.w3.org/2000/svg'>
                            <path
                              fillRule='evenodd'
                          ...
                          {value?.genres.map((genera, index) => {
                            return (
                              <span key={index} className='inline hover:underline text-green-400'>
                                {index > 0 ? <span className='inline  dark:text-green-400'>,</span> : <p></p>} {genera}
                              </span>
                            )
                          })}
                        </p>
                      ...
                      <div className='flex flex-row flex-wrap w-72 mb-5'>
                        ...
                        <p className='md:font-sans font-bold text-xs '>
                          Followers
                          <span className='text-green-400 mx-1'>{value?.followers?.total}</span>
                        </p>
                      </div>
                    </div>
                  </div>
